# @title 🎨 Four Models: JMLR-Compliant Figures (B&W) — NO DUPLICATE TITLES
# @markdown Версия без заголовков над рисунками (убраны дублирующие надписи)
...
# ============================================================================
# FIGURE 1: Model Comparison (B&W) — ИСПРАВЛЕНО: убран заголовок
# ============================================================================
def generate_figure_1_bw():
    """Figure 1: Geometric representations — без заголовка над рисунком"""
    
    fig, axes = plt.subplots(2, 2, figsize=(7, 7))
    # УДАЛЕНО: fig.suptitle('Figure 1: Geometric Representations...')
...
# ============================================================================
# FIGURE 2: Trade-off Curve (B&W) — ИСПРАВЛЕНО: убран заголовок
# ============================================================================
def generate_figure_2_bw():
    """Figure 2: Capacity-Stability Trade-off — без заголовка над рисунком"""
    ...
    # УДАЛЕНО: ax.set_title('Figure 2: Fundamental Capacity-Stability Trade-off...')
...
# ============================================================================
# FIGURE 3: Condition Number Scaling (B&W) — ИСПРАВЛЕНО: убран заголовок
# ============================================================================
def generate_figure_3_bw():
    """Figure 3: Condition number scaling — без заголовка над рисунком"""
    ...
    # УДАЛЕНО: ax.set_title('Figure 3: Stability — Condition Number Scaling')
...
# ============================================================================
print("\n" + "="*70)
print("🎨 GENERATING BLACK & WHITE FIGURES (NO DUPLICATE TITLES)")
print("="*70 + "\n")
...
print("\n📊 Generated figures (B&W, no titles - captions from LaTeX):")
print(f"  1. {fig1}")
print(f"  2. {fig2}")
print(f"  3. {fig3}")
print("\n📋 Generated tables:")
...
print("📝 Figure captions will be added by LaTeX \\caption{} commands")
print("="*70)